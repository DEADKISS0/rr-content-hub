...
export function IdeaCollaboration({ projectSlug, ideaId }: { projectSlug: string; ideaId: string }) {
  ...
  return <section className="mt-8 border-t-2 border-blanco pt-8" aria-labelledby="collaboration-title">
    ...
    {PUBLIC_MODE && <p className="mb-5 border-2 border-mostaza bg-mostaza/10 p-4 font-mono text-[10px] leading-5 text-blanco anim-fade">[MODO PÚBLICO · SOLO LECTURA] El hilo de decisiones y el historial de entregas son visibles. Comentar, resolver o subir archivos requiere una cuenta autorizada.</p>}
