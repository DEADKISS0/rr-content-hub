...
export function IdeasBoard({ ideas, projectSlug }: { ideas: Idea[]; projectSlug: string }) {
  ...
  return <div>
    <div className="mb-4 border-l-2 border-mostaza bg-mostaza/10 px-4 py-3 font-mono text-[10px] leading-5 text-blanco-60">[WORKSPACE_MODE] Las nuevas ideas quedan operativas en este navegador mientras terminamos la sincronización segura con Supabase.</div>
