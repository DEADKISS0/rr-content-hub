    ...
    <header className="sticky top-0 z-20 border-b-2 border-mostaza bg-negro/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-5 py-3 md:px-10">
        ...
        <nav className="flex flex-wrap items-center gap-4">
          <Link href="/audit" className="font-mono text-[10px] text-blanco-60 hover:text-mostaza">PROYECTOS</Link>
          <Link href="/audit/admin" className="font-mono text-[10px] text-blanco-60 hover:text-mostaza">ADMIN</Link>
